  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE students (id BIGINT UNSIGNED PRIMARY KEY AUTO_INCREMENT, 
        ...
        first_name VARCHAR(200) NOT NULL, last_name VARCHAR(80) NOT NULL,
        middle_name VARCHAR(80), date_of_birth VARCHAR(80) NOT NULL, level VARCHAR(50) NOT NULL, address VARCHAR(255) NOT NULL,
